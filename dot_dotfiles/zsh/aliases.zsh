...
alias ls='exa -1 --color=auto --icons -s type --group-directories-first'
alias -g ls='exa -1 --color=auto --icons -s type --group-directories-first'
alias tree='exa -s type --group-directories-first --tree --icons --colour-scale'
